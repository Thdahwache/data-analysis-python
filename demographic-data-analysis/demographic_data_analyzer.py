...
def calculate_demographic_data(print_data=True):
    ...
    percentage_bachelors = round(df[df['education'] == 'Bachelors'].education.count()/df.shape[0],3)*100
    ...
    lower_education_rich = round(lower_education[lower_education['salary'] == '>50K'].salary.count()/lower_education.shape[0],3)*100
    ...
    rich_percentage = round(num_min_workers[num_min_workers['salary'] == '>50K'].salary.count()/num_min_workers.shape[0],3)*100
